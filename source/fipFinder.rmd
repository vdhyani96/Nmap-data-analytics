...
In this work, I have taken on a data analytics approach to solving the problem we used to face in our LAN and exploring the usage of the network. The system I have developed works well in this current scope. Although we can't directly verify the predictions of the model for the future examples, as the usage pattern may change and the hostel batch will change too and therefore, a different set of people will start using the network, we may find that the predictions are correlated to what we found earlier in the data analysis about the most and least frequent IP addresses on different days. Moreover, the machine learning system has the capacity to accommodate well for the future examples too, provided more new examples are fed to it after the batch changes or some other major change occurs. 
